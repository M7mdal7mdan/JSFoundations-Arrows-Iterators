...
let tempreatureInCel =  temperatures.map(temperature=> (temperature - 32) * (5/9))
return tempreatureInCel;
};
...
let exceedTheshhold =temperatures.filter(element => element > threshhold);
return exceedTheshhold ;
};
